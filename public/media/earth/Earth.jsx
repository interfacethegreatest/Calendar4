...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/media/earth/earth.gltf')
  ...
  useFrame(() => {
    if (earthRef.current) {
      earthRef.current.rotation.y += -0.0075 // Adjust this value to control speed
    }
  })

  return (
    <group ref={earthRef} {...props} dispose={null}>
      <mesh geometry={nodes.Object_4.geometry} material={materials['Scene_-_Root']} scale={2.8} />
    </group>
  )
}
